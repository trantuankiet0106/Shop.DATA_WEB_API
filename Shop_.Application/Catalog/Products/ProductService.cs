using My_shop.Application.Common;
...
using My_shop.Utilities.Constants;
using My_shop.Utilities.Exceptions;
...
namespace My_shop.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new My_shopException($"Cannot find a product: {productId}");
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            if (image == null)
                throw new My_shopException($"Cannot find an image with id {imageId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new My_shopException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new My_shopException($"Cannot find a product with id: {productId}");
